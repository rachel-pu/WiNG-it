    ...
    return (
        ...
        <div className="relative h-screen w-full bg-colorF3F1EA bg-[linear-gradient(to_right,#69ADFF50_1px,transparent_1px),linear-gradient(to_bottom,#69ADFF50_1px,transparent_1px)] bg-[size:24px_24px] flex justify-center items-center">
            ...
            <div className="flex items-center space-x-6">
                ...
                {/* ready button */}
                <div>
                    <button className="text-2xl font-dm-sans tracking-tight bg-colorFAF8F1 text-color282523 py-2 px-8 rounded-full font-semibold shadow-lg flex items-center space-x-2 transition-transform duration-300 transform hover:scale-105">
                        <span>I&apos;m Ready!</span>
