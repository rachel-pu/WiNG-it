        ...
        <SignedIn>
                ...
                >
                    ...
                    <Typography color={"black"} fontFamily={"DM Sans"} fontSize={"1rem"}>
                        ...
                        Choose from answering 1–10 questions, type in the role you want to practice for, and receive personalized feedback.
                        Have fun practicing!
                    </Typography>
                    </Box>
                    </motion.div>
                ...
                {/*  div box of both instructions + options to choose  */}
                    ...
                    {/*  instructions box  */}
                    <Box sx={{marginTop: '20px',backgroundColor: '#d9d7d0', padding: '30px', borderRadius: '20px', boxShadow: 4, width: '50%'}}>
                    {
                        /*  step components  */}
                    ...
                    {/*  options box  */}
                     ...
                     <Box sx={{marginTop: '20px',backgroundColor: '#d9d7d0', padding: '30px', borderRadius: '20px', boxShadow: 4, width: '50%', display: 'flex', flexDirection: 'column'}}>
                         <FormLabel
                             sx={{
                                 color: '#000',
                                 '&.Mui-focused': {
                        ...
                        <Box flex={1} display={'flex'} flexDirection={'column'} gap={'4%'}>
                         {/* description */}
                            <Typography color={"#91908C"} fontSize={"0.9rem"} >
                                Customize your interview experience by filling out the following fields. Leaving the fields blank will give you a general experience.
                            </Typography>

                         {/*  typing in role + num questions */}
                         <Box  flexDirection={'horizontal'} fullwidth display={'flex'} justifyContent={'space-between'} gap={'2.5%'}>
                             {/* job role text input */}
                             <TextField id="outlined-basic" value={jobRole} onChange={handleJobRoleChange} fullWidth label="Enter Job Role" placeholder="e.g. Software Engineer" variant="outlined" InputLabelProps={{ style: { fontFamily: 'DM Sans'} }} InputProps={{ style: { fontFamily: 'DM Sans' } }} />
                            ...
                            <Box fullwidth display={'flex'} justifyContent={'space-between'} gap={'2.5%'}>
                                ...
                                <FormControl>
                                    ...
                                    <Typography fontSize={"0.9rem"} color={'#91908C'} >
                                        Choose a difficulty level to match the style you want to practice.                                    </Typography>
                                    <RadioGroup
                                        row
                                        name="row-radio-buttons-group"
                                    >
                                        <FormControlLabel value="easy-going-personality" control={<Radio />} label="Easy-going" />
                                        <FormControlLabel value="professional-personality" control={<Radio />} label="Professional" />
                                        <FormControlLabel value="intense-personality" control={<Radio />} label="Intense" />
                                        <FormControlLabel value="randomize-personality" control={<Radio />} label="Randomize" />
                                    </RadioGroup>
                                </FormControl>
