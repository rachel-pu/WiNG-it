...
const Instructions = () => {
  return (
      ...
      <div className="relative h-screen w-full bg-colorF3F1EA bg-[linear-gradient(to_right,#69ADFF50_1px,transparent_1px),linear-gradient(to_bottom,#69ADFF50_1px,transparent_1px)] bg-[size:24px_24px] flex justify-center items-center">
          ...
          {/* main content box */}
          <div
              className="mx-auto bg-gradient-to-r from-color7DBE73/60 via-color589C9B/60 to-color2E89BA/60 w-4/5 h-10/12 p-20 rounded-3xl shadow-lg relative">
              ...
              <p className="text-color282523 text-2xl tracking-tight mb-8 text-left pl-16 font-satoshi">
                  This is a simulation specifically to help you practice talking to recruiters.
              ...
              <ul className="list-disc pl-24 pb-24 text-color282523 text-2xl tracking-tight text-left font-satoshi">
                  ...
                  <li>You will answer
                      <span
                          className="bg-colorFAF8F1 text-color282523 font-semibold px-2 py-1 rounded-md ml-2 shadow-lg relative">3 recruiters</span>
                  </li>
